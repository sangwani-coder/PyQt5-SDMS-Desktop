...
class Ui_class_form(object):
    def setupUi(self, class_form):
        ...
        self.pushButton = QtWidgets.QPushButton(class_form)
    ...
    def retranslateUi(self, class_form):
        ...
        self.pushButton.setText(_translate("class_form", "Search"))
        self.pushButton_2.setText(_translate("class_form", "Select Term/Year"))
        self.comboBox_3.setItemText(0, _translate("class_form", "Term 1"))
        self.comboBox_3.setItemText(1, _translate("class_form", "Term 2"))
        self.comboBox_3.setItemText(2, _translate("class_form", "Term 3"))
        self.comboBox_4.setItemText(0, _translate("class_form", "2021"))
        self.comboBox_4.setItemText(1, _translate("class_form", "2022"))
        self.comboBox_4.setItemText(2, _translate("class_form", "2023"))
